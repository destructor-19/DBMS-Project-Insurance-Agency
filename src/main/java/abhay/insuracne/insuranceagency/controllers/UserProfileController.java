package abhay.insuracne.insuranceagency.controllers;

import abhay.insuracne.insuranceagency.models.*;
import abhay.insuracne.insuranceagency.services.*;
...
public class UserProfileController {
    ...
    public String profilePage(Model model){
        ...
        model.addAttribute("user",user);
        List<HealthClaim> phealthClaims = healthClaimServices.allProcessedOfUser(user.getId());
        model.addAttribute("phealthClaims",phealthClaims);
        List<VehicleClaims> pvehicleClaims = vehicleClaimsService.allProcessedOfUser(user.getId());
        model.addAttribute("pvehicleClaims",pvehicleClaims);
        List<PropertyClaim> ppropertyClaims = propertyClaimsServices.allProcessedOfUser(user.getId());
        model.addAttribute("ppropertyClaims",ppropertyClaims);
        model.addAttribute("user",user);
